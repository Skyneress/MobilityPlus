...
const JobDetailScreen = ({ navigation, route }) => {
  ...
  const handleAcceptJob = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Cita Aceptada",
        "El paciente será notificado. El chat ya está activo."
      );
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text className="text-texto-claro font-semibold">
            Volver al Panel
          </Text>
      ...
      <ScrollView className="flex-1 p-4">
        ...
        <DetailSection title="Detalles del Paciente">
          ...
          <InfoRow
            icon="call-outline"
            label="Contacto"
            value={appointment.patientPhoneNumber || "No disponible"}
          />
              
          <InfoRow
            icon="cash-outline"
            label="Tarifa Estimada"
            value={`$${appointment.price} CLP`}
          />
        ...
        <DetailSection title="Detalles del Servicio">
          ...
          <Text className="text-base font-semibold text-texto-oscuro mt-4 mb-2">
            Notas Médicas:
          </Text>
        ...
        <View className="flex-row justify-between space-x-3">
          ...
          >
            ...
            {loadingReject ? (
              ...
              <Text className="text-error-rojo text-lg font-bold">
                Rechazar
              </Text>
            )}
